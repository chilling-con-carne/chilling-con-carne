<template>
    ...
    <section id="about-content" class="m-auto w-3/4 md:w-2/3 lg:w-1/2 flex flex-col gap-2 md:gap-8 mb-24 scroll-mt-24">
        <AboutPortrait v-for="about in abouts" :key="about.name" :about="about" />
    </section>
</template>
